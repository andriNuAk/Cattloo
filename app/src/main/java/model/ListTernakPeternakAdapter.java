...
public class ListTernakPeternakAdapter extends RecyclerView.Adapter {

    Context context;
    ArrayList<TernakPeternak> ternakList;

    public ListTernakPeternakAdapter(Context context, ArrayList<TernakPeternak> ternakList) {
